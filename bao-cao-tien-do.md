...
|---|---|---|
| Qdrant (vector) | 219 chunks | Specs, giá, bảo hành, pin, FAQ, dịch vụ |
| PostgreSQL (structured) | 12 records | Giá VF3/VF5/VF8/VF9 + specs (seats, cargo, motor, battery, range) |
| BM25 index | 2298 terms | Vocabulary cho keyword search |
...
| Feature | Mô tả | File |
|---|---|---|
| Chunking | 4 strategies: SpecsChunker, FAQChunker, PriceChunker, GuideChunker | `app/core/chunking.py` |
| Embedding | sentence-transformers local (384 dims, multilingual) | `app/core/embedding.py` |
| BM25 Sparse | Custom BM25 index (2298 terms) | `app/core/sparse.py` |
...
│   │   ├── ingestion.py          # Data ingestion (JSON → structured)
